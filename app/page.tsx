...
const Home = () => {
  ...
  const experienceData = [
    {
      ...
      type: "Part Time",
      description:
        "My primary responsibility is to maintain a safe and secure environment for customers, employees, and assets. I actively monitor the premises, conduct regular patrols, and respond promptly to any alarms or security concerns.",
      points: [
      ...
      links: [
        {
          ...
          href: "RealCanadianSuperStore/LCL - Reference Letter 2025-02-12.pdf",
          download: true,
          icon: Download,
        },
      ],
    },
    {
      ...
      type: "Part Time",
      description:
        "Worked with the TechGear program for Paragon PMO to develop a mobile application for the First Nation population of Canada to help them clear their driving license test. My main role was as a Business Analyst, ensuring requirements were met.",
      points: [
      ...
      links: [
        {
          name: "Download Application (Roadschool v1.0)",
          href: "TechGear/Roadschool.apk",
          download: true,
          icon: Download,
        },
        {
          name: "Github Source Code",
          href: "https://github.com/saranshahuja/roadschool",
          download: false,
          icon: Github,
        },
        {
          name: "Employment Credentials",
          href: "TechGear/Techgear-Confirmation.jpg",
          download: true,
          icon: FileText,
        },
      ],
    },
    {
      ...
      type: "Full-Time",
      description:
        "Worked across Social Media Management (SMM), Search Engine Optimisation (SEO), and Website Management (WM) departments. Received the 'India’s Most Trusted Brand of the Year 2023' award during my tenure.",
      points: [
      ...
      imageSrc: "DigitalSeries/DSmain.png",
      links: [
        {
          name: "Email Confirmation",
          href: "DigitalSeries/Re_ [EXTERNAL]Experience Confirmation of Manpreet Singh.eml",
          download: true,
          icon: FileText,
        },
      ],
  ...
  const certificationData = [
    {
      title: "Security Workers License",
      issuer: "Justice Institute of British Columbia",
      date: "September 24, 2024",
      file: "Certifications/BST JIBC.pdf",
    },
    {
      title: "Serving it Right",
      issuer: "Responsible Service BC",
      date: "September 23, 2024",
      file: "Certifications/Serving It Right.pdf",
    },
    {
      title: "Ethical Hacking Android (Basics)",
      issuer: "Frank Anemaet",
      date: "May 11, 2024",
      file: "Certifications/UC-8633bd5d-8c6e-45c8-882c-24feb2699dc4.pdf",
    },
  ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 lg:gap-10 items-start mt-6">
              ...
              <div className="col-span-1 md:col-span-2">
                <p className={`${COLOR_TEXT_LIGHT} text-lg mb-4 leading-relaxed`}>
                  I am a motivated BCIS student at University of Fraser Valley. At my core, I am a collaborative team player who is committed to building strong relationships and fostering positive working environments. I believe that success is best achieved through hard work, dedication, and a positive attitude, and I always strive to live up to these values in everything I do.
                </p>
